...
# 3. Hypothesis: PSC disease is associated with fecal calprotectin
...
```{r, warning=FALSE}
path = "../results/Q5b/alpha_diversity"
```
...
pdf("../figures/Q5b/alpha_diversity_terminal_ileum.pdf",
    height =4,width = 6)
p_boxplot_alpha
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../figures/Q5b/alpha_diversity_terminal_ileum2.pdf",
    height =4,width = 6)
p_boxplot_alpha
dev.off()
```
...
```{r, warning=FALSE}
path = "../results/Q5b/beta_diversity"
```
...
```{r,results='hide', echo=FALSE}
pdf("../figures/Q5b/beta_diversity_terminal_ileum.pdf",
    height =5,width = 5)
p
dev.off()
```
...
```{r, warning=FALSE}
# needed paths
path = "../results/Q5b/univariate_analysis"
...
pdf("../figures/Q5b/dotplot_terminal_ileum.pdf",
    height =10,width = 4)
p
dev.off()
```
...
```{r, warning=FALSE}
roc_curve_all_custom(roc_cs[2],Q="Q5",
...
pdf("../figures/Q5b/models_terminal_ileum.pdf",
    height =10,width = 10)
p
dev.off()
```
...
# save the results
alpha_div_plots[[paste(segment,"Countries")]] <- p_boxplot_alpha
...
```{r,results='hide', echo=FALSE}
pdf("../figures/Q5b/alpha_diversity_colon.pdf",
    height =4,width = 6)
p_boxplot_alpha
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../figures/Q5b/alpha_diversity_colon2.pdf",
    height =4,width = 6)
p_boxplot_alpha
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../figures/Q5b/beta_diversity_colon.pdf",
    height =5,width = 5)
p
dev.off()
```
...
```{r,results='hide',eval=FALSE, echo=FALSE}
pdf("../figures/Q5b/dotplot_colon.pdf",
    height =10,width = 4)
p
dev.off()
```
...
```{r, warning=FALSE}
roc_curve_all_custom(roc_cs[4],Q="Q5",
                     model_name="enet_model")
```
...
```{r,results='hide', echo=FALSE, warning=FALSE}
pdf("../figures/Q5b/models_colon.pdf",
    height =10,width = 10)
p
dev.off()
```
...
alpha_beta_elastic <- ggarrange(Q5_alpha,genus_Q5_beta,roc_curve_plot,
...
```{r,results='hide', echo=FALSE}
pdf("../figures/Q5b/supplement_1.pdf",paper = "a4",height = 10,width = 12)
alpha_beta_elastic
dev.off()
```
...
```{r,results='hide', eval=FALSE, echo=FALSE}
pdf("../figures/Q5b/supplement_2.pdf",
