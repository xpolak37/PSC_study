...
psc_taxa <- read.xlsx("results/Q1/PSC_effect_terminal_ileum.xlsx",sheet = "Ileum Genus")
...
# Save edge list
write_csv(edge_list, "results/Q1/network/Genus terminal ileum/taxon_network_edges.csv")

# Save node attributes
psc_effect_ileum_genus <- read.xlsx("results/Q1/PSC_effect_terminal_ileum.xlsx",sheet = "Ileum Genus")
...
write_csv(node_attributes, "results/Q1/network/Genus terminal ileum/taxon_network_nodes.csv")
...
similarity_threshold <- 0.3  # Minimum association strength
p_value_threshold <- 1.02  # Maximum p-value for significance
psc_taxa <- read.xlsx("results/Q1/PSC_effect_colon.xlsx",sheet = "colon Genus")
psc_taxa <- psc_taxa$ASV
...
# Save edge list
write_csv(edge_list, "results/Q1/network/Genus colon/taxon_network_edges.csv")

# Save node attributes
psc_effect_colon_genus <- read.xlsx("results/Q1/PSC_effect_colon.xlsx",sheet = "colon Genus")
...
write_csv(node_attributes, "results/Q1/network/Genus colon/taxon_network_nodes.csv")
