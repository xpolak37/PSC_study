...
pdf("../figures/Q5/alpha_diversity_terminal_ileum.pdf",
    height =4,width = 6)
p_boxplot_alpha
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../figures/Q5/alpha_diversity_terminal_ileum2.pdf",
    height =4,width = 6)
p_boxplot_alpha
dev.off()
```
...
```{r, warning=FALSE}
# needed paths
path = "../results/Q5/univariate_analysis"
...
pdf("../figures/Q5/dotplot_terminal_ileum.pdf",
    height =10,width = 4)
p
dev.off()
```
...
pdf("../figures/Q5/models_terminal_ileum.pdf",
    height =10,width = 10)
p
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../figures/Q5/alpha_diversity_colon.pdf",
    height =4,width = 6)
p_boxplot_alpha
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../figures/Q5/alpha_diversity_colon2.pdf",
    height =4,width = 6)
p_boxplot_alpha
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../figures/Q5/beta_diversity_colon.pdf",
    height =5,width = 5)
p
dev.off()
```
...
```{r,results='hide',eval=FALSE, echo=FALSE}
pdf("../figures/Q5/dotplot_colon.pdf",
    height =10,width = 4)
p
dev.off()
```
...
```{r,results='hide', echo=FALSE, warning=FALSE}
pdf("../figures/Q5/models_colon.pdf",
    height =10,width = 10)
p
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../figures/Q5/supplement_1.pdf",paper = "a4",height = 10,width = 12)
alpha_beta_elastic
dev.off()
```
...
```{r,results='hide', eval=FALSE, echo=FALSE}
pdf("../figures/Q5/supplement_2.pdf",
