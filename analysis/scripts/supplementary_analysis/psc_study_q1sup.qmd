...
# prepare the data
linda_data <- binomial_prep(rcolon_asv_tab,
                            rcolon_taxa_tab,
                            rcolon_metadata,
                            group, usage="linDA")
...
# prepare the data
linda_data <- binomial_prep(rcolon_asv_tab,rcolon_taxa_tab,
                            rcolon_metadata,group, usage="linDA")
...
dotheatmap_linda <- dot_heatmap_linda(list_heatmap,uni_statistics$colon[grepl(level,names(uni_statistics$colon))],rcolon_taxa_tab)
dotheatmap_linda
```
...
```{r,warning=FALSE}
phylum_data <- aggregate_taxa(rcolon_asv_tab,
                             rcolon_taxa_tab,
                             taxonomic_level = "Phylum")

rcolon_phylum_tab <- phylum_data[[1]]
rcolon_phylum_taxa_tab <- phylum_data[[2]]
...
# prepare the data
linda_data <- binomial_prep(rcolon_phylum_tab,
                            rcolon_phylum_taxa_tab,
                            rcolon_metadata,
                            group, usage="linDA")
