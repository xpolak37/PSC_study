...
write.xlsx(psc_effect,
          file.path(path,"univariate_analysis",paste0("supplements_psc_effect_",segment,".csv")),
          row.names = FALSE)
```
...
# save the results
supplements_models[["models_summ"]][["knn"]][[model_name]] <- knn_model$model_summary
supplements_models[["roc_cs"]][["knn"]][[model_name]] <- knn_model$kfold_rocobjs
...
# save the results
supplements_models[["models_summ"]][["rf"]][[model_name]] <- rf_model$model_summary
supplements_models[["roc_cs"]][["rf"]][[model_name]] <- rf_model$kfold_rocobjs
...
# save the results
supplements_models[["models_summ"]][["gbm"]][[model_name]] <- gbm_model$model_summary
supplements_models[["roc_cs"]][["gbm"]][[model_name]] <- gbm_model$kfold_rocobjs
...
# save the results
supplements_models[["models_summ"]][["knn_ra"]][[model_name]] <- knn_model$model_summary

supplements_models[["roc_cs"]][["knn_ra"]][[model_name]] <- knn_model$kfold_rocobjs
...
# save the results
supplements_models[["models_summ"]][["rf_ra"]][[model_name]] <- rf_model$model_summary

supplements_models[["roc_cs"]][["rf_ra"]][[model_name]] <- rf_model$kfold_rocobjs
...
for (model_name in names(supplements_models$models_summ)){
  models_summ_df <- do.call(rbind, 
  supplements_models$models_summ[model_name])
  write.csv(models_summ_df,file.path(path,paste0(model_name,"_",segment,".csv")))
