...
```{r, warning=FALSE}
path = "../results/Q3b/alpha_diversity"
```
...
pdf("../figures/Q3b/alpha_diversity_terminal_ileum.pdf",
    height =4,width = 6)
p_boxplot_alpha
dev.off()
```
...
```{r, warning=FALSE}
path = "../results/Q3b/beta_diversity"
```
...
```{r,results='hide', echo=FALSE}
pdf("../figures/Q3b/beta_diversity_terminal_ileum.pdf",
    height =5,width = 5)
p
dev.off()
```
...
```{r, warning=FALSE}
# needed paths
path = "../results/Q3b/univariate_analysis"
...
pdf("../figures/Q3b/dotplot_terminal_ileum.pdf",
    height =10,width = 4)
p
dev.off()
```
...
```{r, warning=FALSE}
path_maaslin="../intermediate_files/maaslin/Q3b/ASV/"
```
...
```{r, warning=FALSE}
path_maaslin="../intermediate_files/maaslin/Q3b/Phylum/"
```
...
```{r,results='hide', echo=FALSE}
pdf("../figures/Q3b/alpha_diversity_colon.pdf",
    height =4,width = 7)
p_boxplot_alpha
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../figures/Q3b/beta_diversity_colon.pdf",
    height =5,width = 5)
p
dev.off()
```
...
```{r,results='hide',eval=FALSE, echo=FALSE}
pdf("../figures/Q3b/dotplot_colon.pdf",
    height =10,width = 4)
p
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../figures/Q3b/FIGURE7.pdf",paper = "a4",height = 7,width = 12)
alpha_beta
dev.off()
```
...
```{r,results='hide', eval=FALSE, echo=FALSE}
pdf("../figures/Q3b/supplement_2.pdf",
