...
pdf("../../../figures/merged_sites/Q1/alpha_diversity_terminal_ileum.pdf",
    height =4,width = 7)
p_boxplot_alpha
dev.off()
```
...
```{r, warning=FALSE,results='hide',echo=FALSE}
pdf("../../../figures/merged_sites/Q1/beta_diversity_terminal_ileum.pdf",
    height =5,width = 5)
p
dev.off()
```
...
```{r, warning=FALSE, fig.width=10, fig.height=15, fig.fullwidth=TRUE}
...
```{r, warning=FALSE,results='hide',echo=FALSE}
pdf("../../../figures/merged_sites/Q1/dotplot_terminal_ileum.pdf",
    height =10,width = 4)
p
dev.off()
```
...
```
```{r, warning=FALSE,results='hide',echo=FALSE}
pdf("../../../figures/merged_sites/Q1/enet_terminal_ileum.pdf",paper = "a4",height = 5,width = 5)
p
dev.off()
```
...
```{r, warning=FALSE,results='hide',echo=FALSE}
pdf("../../../figures/merged_sites/Q1/alpha_diversity_colon.pdf",
    height =4,width = 7)
p_boxplot_alpha
dev.off()
```
...
```{r, warning=FALSE,results='hide',echo=FALSE}
pdf("../../../figures/merged_sites/Q1/beta_diversity_colon.pdf",
    height =5,width = 5)
p
dev.off()
```
...
```{r, warning=FALSE, fig.width=4, fig.height=10, fig.fullwidth=TRUE}
...
```{r, warning=FALSE,results='hide',echo=FALSE}
pdf("../../../figures/merged_sites/Q1/dotplot_colon.pdf",
    height =10,width = 4)
p
dev.off()
```
...
```
```{r, warning=FALSE,results='hide',echo=FALSE}
pdf("../../../figures/merged_sites/Q1/enet_colon.pdf",paper = "a4",height = 5,width = 5)
p
dev.off()
```
...
```{r, warning=FALSE,results='hide',echo=FALSE}
pdf("../../../figures/merged_sites/Q1/FIGURE2.pdf",paper = "a4",height = 10,width = 12)
alpha_beta_elastic
dev.off()
```
...
```{r, warning=FALSE,results='hide',echo=FALSE}
pdf("../../../figures/merged_sites/Q1/FIGURE3.pdf",
