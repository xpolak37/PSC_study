...
subtitle: "5b. Hypothesis: PSC disease is associated with fecal calprotectin"
format: 
  html:  
...
**This script is identical to Q5, with the only exception being that different individuals are analysed — pre-LTx only**
...
```{r, warning=FALSE}
path = "../../../results/merged_sites/main_analysis/Q5b/alpha_diversity"
```
...
pdf("../../../figures/merged_sites/Q5b/alpha_diversity_terminal_ileum.pdf",
    height =4,width = 6)
p_boxplot_alpha
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q5b/alpha_diversity_terminal_ileum2.pdf",
    height =4,width = 6)
p_boxplot_alpha
dev.off()
```
...
```{r, warning=FALSE}
path = "../../../results/merged_sites/main_analysis/Q5b/beta_diversity"
```
...
```{r,results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q5b/beta_diversity_terminal_ileum.pdf",
    height =5,width = 5)
p
dev.off()
```
...
```{r, warning=FALSE}
# needed paths
path = "../../../results/merged_sites/main_analysis/Q5b/univariate_analysis"
...
pdf("../../../figures/merged_sites/Q5b/dotplot_terminal_ileum.pdf",
    height =10,width = 4)
p
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q5b/alpha_diversity_colon.pdf",
    height =4,width = 6)
p_boxplot_alpha
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q5b/alpha_diversity_colon2.pdf",
    height =4,width = 6)
p_boxplot_alpha
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q5b/beta_diversity_colon.pdf",
    height =5,width = 5)
p
dev.off()
```
...
```{r,results='hide',eval=FALSE, echo=FALSE}
pdf("../../../figures/merged_sites/Q5b/dotplot_colon.pdf",
    height =10,width = 4)
p
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q5b/Supplementary_figure",paper = "a4",height = 7,width = 12)
alpha_beta
dev.off()
```
