...
pdf("../../../figures/merged_sites/Q3/alpha_diversity_terminal_ileum.pdf",
    height =4,width = 6)
p_boxplot_alpha
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q3/beta_diversity_terminal_ileum.pdf",
    height =5,width = 5)
p
dev.off()
```
...
pdf("../../../figures/merged_sites/Q3/dotplot_terminal_ileum.pdf",
    height =10,width = 4)
p
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q3/alpha_diversity_colon.pdf",
    height =4,width = 7)
p_boxplot_alpha
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q3/beta_diversity_colon.pdf",
    height =5,width = 5)
p
dev.off()
```
...
```{r,results='hide',eval=FALSE, echo=FALSE}
pdf("../../../figures/merged_sites/Q3/dotplot_colon.pdf",
    height =10,width = 4)
p
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q3/Supplement_figure_2A.pdf",paper = "a4",height = 7,width = 12)
alpha_beta
dev.off()
```
...
```{r,results='hide', eval=FALSE, echo=FALSE}
pdf("../../../figures/merged_sites/Q3/supplement_2.pdf",
    height =10,width = 8,paper="a4")
heatmap_plot
dev.off()
```

## Supplement Figure - Akkermansia

```{r,  warning=FALSE, fig.width=7, fig.height=6, fig.fullwidth=TRUE}
...
```{r,results='hide', eval=FALSE, echo=FALSE}
pdf("../../../figures/merged_sites/Q3/supplement_akkermansia.pdf",
