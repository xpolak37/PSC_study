...
pdf("../../../figures/merged_sites/Q2/alpha_diversity_terminal_ileum.pdf",
    height =4,width = 7)
p_boxplot_alpha
dev.off()
```
...
```{r, warning=FALSE, results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q2/beta_diversity_terminal_ileum.pdf",
    height =5,width = 5)
p
dev.off()
```
...
```{r, warning=FALSE, results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q2/dotplot_terminal_ileum.pdf",
    height =10,width = 4)
p
dev.off()
```
...
```{r, warning=FALSE,results='hide',echo=FALSE}
pdf("../../../figures/merged_sites/Q2/enet_terminal_ileum.pdf",height = 5,width = 5)
p
dev.off()
```
...
```{r, warning=FALSE, results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q2/alpha_diversity_colon.pdf",
    height =4,width = 7)
p_boxplot_alpha
dev.off()
```
...
```{r, warning=FALSE, results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q2/beta_diversity_colon.pdf",
    height =5,width = 5)
p
dev.off()
```
...
```{r, warning=FALSE, results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q2/dotplot_colon.pdf",
    height =10,width = 4)
p
dev.off()
```
...
```{r, warning=FALSE,results='hide',echo=FALSE}
pdf("../../../figures/merged_sites/Q2/enet_colon.pdf",height = 5,width = 5)
p
dev.off()
```
...
```{r, warning=FALSE, results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q2/FIGURE4.pdf",paper = "a4",height = 10,width = 12)
alpha_beta_elastic
dev.off()
```
...
```{r, warning=FALSE,  fig.width=10, fig.height=10, fig.fullwidth=TRUE}
...
```{r, warning=FALSE, results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q2/Supplementary_figure.pdf",
