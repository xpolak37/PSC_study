...
subtitle: "3b. Hypothesis: PSC disease is associated with IBD"
format: 
  html:  
...
**This script is identical to Q3, with the only exception being that different individuals are analysed — pre-LTx only**

An IBD vs. no-IBD comparison was performed within PSC patients (pre-LTx individuals) to discover IBD-specific pattern. 
...
```{r, warning=FALSE}
path = "../../../results/merged_sites/main_analysis/Q3b/alpha_diversity"
```
...
pdf("../../../figures/merged_sites/Q3b/alpha_diversity_terminal_ileum.pdf",
    height =4,width = 6)
p_boxplot_alpha
dev.off()
```
...
```{r, warning=FALSE}
path = "../../../results/merged_sites/main_analysis/Q3b/beta_diversity"
```
...
```{r,results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q3b/beta_diversity_terminal_ileum.pdf",
    height =5,width = 5)
p
dev.off()
```
...
```{r, warning=FALSE}
# needed paths
path = "../../../results/merged_sites/main_analysis/Q3b/univariate_analysis"
path_maaslin=file.path("../../../intermediate_files/maaslin/Q3b",level)
```
...
pdf("../../../figures/merged_sites/Q3b/dotplot_terminal_ileum.pdf",
    height =10,width = 4)
p
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q3b/alpha_diversity_colon.pdf",
    height =4,width = 7)
p_boxplot_alpha
dev.off()
```
...
```{r,results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q3b/beta_diversity_colon.pdf",
    height =5,width = 5)
p
dev.off()
```
...
```{r,results='hide',eval=FALSE, echo=FALSE}
pdf("../../../figures/merged_sites/Q3b/dotplot_colon.pdf",
    height =10,width = 4)
p
dev.off()
```
...
Q3b_alpha <- ggarrange(p_A,ggplot() + theme_minimal(),p_B,nrow=1, ncol=3,
                      widths = c(1,0.1,1))
Q3b_alpha
```
...
genus_Q3b_beta <- ggarrange(pca_ti,
                           ggplot() + theme_minimal(),
                           pca_colon,ncol=3,
                           widths = c(1,0.1,1))
genus_Q3b_beta
...
alpha_beta <- ggarrange(Q3b_alpha,genus_Q3b_beta,
...
```{r,results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/Q3b/Supplementary_Figure.pdf",paper = "a4",height = 7,width = 12)
alpha_beta
dev.off()
```
...
```{r,results='hide', eval=FALSE, echo=FALSE}
pdf("../../../figures/merged_sites/Q3b/supplement_2.pdf",
