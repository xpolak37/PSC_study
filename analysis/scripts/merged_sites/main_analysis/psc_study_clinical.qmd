...
pdf("../../../figures/merged_sites/clinical/MDI_terminal_ileum.pdf",
    height =5,width = 5)
p_il_dys_genus
dev.off()
```
...
```{r, warning=FALSE, results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/clinical/MDI_terminal_ileum_ibd.pdf",
    height =5,width = 3)
p_il_dys_genus_ibd
dev.off()
```
...
```{r, warning=FALSE, results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/clinical/MDI_ROC_terminal_ileum.pdf",
    height =5,width = 7)
roc_ileum
dev.off()
```
...
knitr::kable(results_model[[1]][,c("Estimate", "p.adj","sig")],
             digits=10,caption="Results of linear modeling")
```
...
```{r, warning=FALSE, results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/clinical/MDI_colon.pdf",
    height =5,width = 5)
p_col_dys_genus
dev.off()
```
...
```{r, warning=FALSE, results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/clinical/MDI_colon_ibd.pdf",
    height =5,width = 3)
p_col_dys_genus_ibd
dev.off()
```
...
```{r, warning=FALSE, results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/clinical/MDI_ROC_colon.pdf",
    height =5,width = 7)
roc_colon
dev.off()
```
...
```{r, warning=FALSE, results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/clinical/FIGURE5.pdf",
...
write.xlsx(significance_df,"../../../results/merged_sites/main_analysis/clinical/clinical_significance.xlsx")
...
```{r, warning=FALSE,  eval=FALSE, echo=FALSE}
pdf("../../../figures/merged_sites/clinical/clinical_data_boxplots.pdf",height = 15,width =18)
bx
dev.off()
```
...
write.xlsx(significance_df,"../../../results/merged_sites/main_analysis/clinical/clinical_significance_ibd.xlsx")
...
```{r, warning=FALSE,  eval=FALSE, echo=FALSE}
pdf("../../../figures/merged_sites/clinical/clinical_data_boxplots_ibd.pdf",height = 15,width =18)
bx
dev.off()
```
...
```{r, warning=FALSE,  eval=FALSE, echo=FALSE}
pdf("../../../figures/merged_sites/clinical/correlation_genus.pdf",height = 22,width =18)
cl_genus
dev.off()
```
...
p_mdi <- ggplot() + 
  ...
  geom_text(data=p_df_melt_mdi,aes(x=SeqID,y=variable,label=value,vjust=0.6),size=1) + 
...
psc_effect_ileum_genus <- read.xlsx(
  "../../../results/merged_sites/main_analysis/Q1/univariate_analysis/psc_effect_terminal_ileum.xlsx")
...
```{r, warning=FALSE}
psc_effect_colon_genus <- read.xlsx("../../../results/merged_sites/main_analysis/Q1/univariate_analysis/psc_effect_colon.xlsx")
...
mdi_heatmap <- ggarrange(p_mdi,p_ileum,p_colon,ncol = 3,widths = c(0.7,1,1),labels = LETTERS)
mdi_heatmap
```

```{r, warning=FALSE, results='hide', echo=FALSE}
pdf("../../../figures/merged_sites/clinical/FIGURE6.pdf",
    height =5,width = 15)
mdi_heatmap
dev.off()
```
