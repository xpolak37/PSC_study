...
```{r}
asv_tab_ikem <- as.data.frame(fread("../../../data/analysis_ready_data/ikem/asv_table_ikem.csv",check.names = FALSE))
taxa_tab_ikem <- as.data.frame(fread("../../../data/analysis_ready_data/ikem/taxa_table_ikem.csv",check.names = FALSE))
metadata_ikem <- as.data.frame(fread("../../../data/analysis_ready_data/ikem/metadata_ikem.csv",check.names = FALSE))
```

## Norway data

```{r}
asv_tab_norway <- as.data.frame(fread("../../../data/analysis_ready_data/norway/asv_table_norway.csv",check.names = FALSE))
taxa_tab_norway <- as.data.frame(fread("../../../data/analysis_ready_data/norway/taxa_table_norway.csv",check.names = FALSE))
metadata_norway <- as.data.frame(fread("../../../data/analysis_ready_data/norway/metadata_norway.csv",check.names = FALSE))
```
...
# for edges, we have to invert the relative abundances so the higher abundances will be closer to the given sample
edges$inv_relative <- 1/(edges$relative)
```
...
write.table(nodes,"../../results/network_snowflake/ileum/nodes.tsv",row.names = FALSE,sep="\t")
write.table(edges,"../../results/network_snowflake/ileum/edges.tsv",row.names = FALSE,sep="\t")
```
...
# for edges, we have to invert the relative abundances so the higher abundances will be closer to the given sample
edges$relative[edges$relative==0] <- 0.000000001
edges$inv_relative <- 1/(edges$relative)
```
...
write.table(nodes,"../../results/network_snowflake/colon/nodes.tsv",row.names = FALSE,sep="\t")
write.table(edges,"../../results/network_snowflake/colon/edges.tsv",row.names = FALSE,sep="\t")
```
