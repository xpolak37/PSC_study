---
title: "RECURRENCE INDEX CALCULATION"
...
B) MAYO PSC, APRI, FIB, AOM - liver problems
...
```{r, warning=FALSE}
psc_asv <- read.xlsx("../results/Q2/univariate_analysis/supplements_rpsc_effect_terminal_ileum.xlsx",
...
```{r, warning=FALSE}
psc_genus <- read.xlsx("../results/Q2/univariate_analysis/supplements_rpsc_effect_terminal_ileum.xlsx",
...
```{r, warning=FALSE}
psc_asv <- read.xlsx("../results/Q2/univariate_analysis/supplements_rpsc_effect_colon.xlsx",
                     sheet = "colon ASV")
psc_increased_asv <- psc_asv$SeqID[psc_asv$log2FoldChange>0]
psc_decreased_asv <- psc_asv$SeqID[psc_asv$log2FoldChange<0]
```
...
```{r, warning=FALSE}
psc_genus <- read.xlsx("../results/Q2/univariate_analysis/supplements_rpsc_effect_colon.xlsx",
                     sheet = "colon genus")
psc_increased_genus <- psc_genus$SeqID[psc_genus$log2FoldChange>0]
psc_decreased_genus <- psc_genus$SeqID[psc_genus$log2FoldChange<0]
```
...
write.csv(metadata_dysbiosis_final,
          "../../data/clinical_data/recurrence_metadata.csv",row.names = FALSE)
```
