...
```{r, warning=FALSE}
taxa_to_test <- read.xlsx("../results/Q1_czech/univariate_analysis/significant_taxa_terminal_ileum.xlsx", sheet=" genus healthy vs pre_ltx")
...
```{r}
taxa_to_test <- read.xlsx("../results/Q1_czech/univariate_analysis/significant_taxa_colon.xlsx", sheet=" genus healthy vs pre_ltx")
...
```{r, eval=FALSE}
roc_curve_all_custom(roc_cs[c(13:16)],Q="Q2_czech",
                     model_name="enet_model")
```
...
```{r,results='hide'}
pdf("../figures/Q2_czech/models_colon.pdf",
    height =10,width = 10)
p
dev.off()
```
